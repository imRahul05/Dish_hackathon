...
import { signOut } from "firebase/auth"; // Added import
import { auth } from "@/firebase/firebase"; // Added import
import { toast } from "react-toastify"; // Added import if not already present
...
const UserLayout = () => {
  ...
  const handleLogout = async () => {
    try {
      ...
      toast.error("Logout failed. Please try again."); // Optional: Notify user of logout failure
    }
  };
